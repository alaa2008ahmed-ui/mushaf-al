...
export const presetThemes: { [key: string]: Theme } = {
    daylight: { name: "☀️ نهاري (افتراضي)", bgColor: "#F3F4F6", textColor: "#111827", font: "'Cairo', sans-serif", palette: ["#3b82f6", "#10b981", "#9333ea"] },
    ...
    dhuhr: { name: "☀️ الظهر", bgColor: "#fef3c7", palette: ["#fbbf24", "#f59e0b", "#d97706"], textColor: "#78350f", font: "'Amiri', serif", barBg: "#fef3c7", barBorder: "1px solid #f59e0b" },
    asr: { name: "🌤️ العصر", bgColor: "#fed7aa", palette: ["#fb923c", "#f97316", "#ea580c"], textColor: "#7c2d12", font: "'Scheherazade New', serif", barBg: "#fed7aa", barBorder: "1px solid #f97316" },
